...
(function() {
  ...
  function log(message, data = null, level = 'info') {
    ...
    const prefix = `[UTMIFY-INTERCEPTOR-PRIVACY] [${timestamp}] [+${timeSinceLoad}ms]`;
  ...
  function generateFinalReport() {
    ...
    log('📋 RELATÓRIO FINAL DO INTERCEPTADOR (PRIVACY):', {
  ...
  function initialize() {
    log('🚀 Inicializando interceptador do Pixel da UTMify (Privacy)');
